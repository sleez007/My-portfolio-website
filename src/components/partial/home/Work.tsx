      ...
      <Container>
        ...
        <div className="grid expo even-columns">
          ...
          <div className="expo__skill-set">
            <p>
              I&#39;ve worked in full capacity as a fullstack Web and Mobile App
              developer in every of the afore mentioned organization.
            </p>
            <Fade ssrFadeout bottom>
...
const SkillWrap = ({ title, icon }: d) => {
  return (
    <div className="box">
      ...
      <a href="mailto:etokakingsley@gmail.com">
        <p>
